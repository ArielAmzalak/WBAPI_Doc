+++
id = "send-marketing-messages"
title = "Sending messages"
summary = "Marketing Messages for WhatsApp allows you to send Marketing template messages only."
source = "https://developers.facebook.com/docs/whatsapp/send-marketing-messages"
lang = "en"
tags = ["whatsapp-business-platform", "marketing-messages-lite-api", "webhooks", "messaging", "templates"]
+++
# Sending messages
...
If you use a partners UI portals or APIs to configure and send marketing messages, you can continue to do so, and do not need to use any of the below capabilities - your partner will take care of integrating with MM API for WhatsApp's message sending functions on your behalf.
...
All optimization features are enabled by default, but you can use the creative\_features\_spec object to specify which optimizations you want to enable (opt-in) or disable (opt-out) for the entire Whatsapp business account. To do this, set each optimizations enroll\_status property that you wish to modify to either OPT\_IN or OPT\_OUT. For example:
