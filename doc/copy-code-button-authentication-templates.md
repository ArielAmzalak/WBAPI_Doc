+++
id = "copy-code-button-authentication-templates"
title = "Copy code authentication templates"
summary = "Copy code authentication templates allow you to send a one-time password or code along with a copy code button to your users."
source = "https://developers.facebook.com/docs/whatsapp/copy-code-button-authentication-templates"
lang = "en"
tags = ["whatsapp-business-platform", "webhooks", "templates", "authentication", "rate-limits"]
+++
