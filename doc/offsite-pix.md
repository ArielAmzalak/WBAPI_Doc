...
summary = "Payments API also enables businesses to collect payments from their customers via WhatsApp using dynamic Pix codes."
source = "https://developers.facebook.com/docs/whatsapp/offsite-pix"
lang = "en"
