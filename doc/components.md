...
summary = "Templates are made up of four primary components which you define when you create a template: header, body, footer, and buttons."
source = "https://developers.facebook.com/docs/whatsapp/components"
lang = "en"
tags = ["whatsapp-business-platform", "webhooks", "messaging", "templates", "phone-numbers", "rate-limits"]
+++
# Template components
