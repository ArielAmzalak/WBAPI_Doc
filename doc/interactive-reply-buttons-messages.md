+++
id = "interactive-reply-buttons-messages"
title = "Interactive reply buttons messages"
summary = "Interactive reply buttons messages allow you to send up to three predefined replies for users to choose from."
source = "https://developers.facebook.com/docs/whatsapp/interactive-reply-buttons-messages"
lang = "en"
...
| `<FOOTER_TEXT>`  *String* | **Required if using a footer.**  Footer text. URLs are automatically hyperlinked.  Maximum 60 characters. | `Lucky Shrub: Your gateway to succulents!TM` |
...
-d '
{
  ...
  "interactive": {
    ...
    "footer": {
      "text": "Lucky Shrub: Your gateway to succulents!TM"
    },
    "action": {
      "buttons": [
        {
