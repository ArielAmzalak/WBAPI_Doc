...
summary = "Cloud API reviews templates and variable parameters using machine learning to protect the security and integrity of Cloud API services."
source = "https://developers.facebook.com/docs/whatsapp/template-review"
lang = "en"
tags = ["whatsapp-business-platform", "webhooks", "templates", "rate-limits", "compliance"]
+++
# Template review
