...
summary = "Image messages are messages that display a single image and an optional caption."
source = "https://developers.facebook.com/docs/whatsapp/image-messages"
lang = "en"
