...
summary = "Reaction messages are emoji-reactions that you can apply to a previous WhatsApp user message that you have received."
source = "https://developers.facebook.com/docs/whatsapp/reaction-messages"
lang = "en"
