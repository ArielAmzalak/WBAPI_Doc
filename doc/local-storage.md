...
id = "local-storage"
title = "Local Storage"
summary = "Local storage offers an additional layer of data management control, by giving you the option to specify where your message data is stored at rest."
source = "https://developers.facebook.com/docs/whatsapp/local-storage"
lang = "en"
tags = ["whatsapp-business-platform", "phone-numbers", "rate-limits"]
+++
# Local Storage
