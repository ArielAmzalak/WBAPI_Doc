+++
id = "orderdetailstemplate"
title = "Send order details template message"
summary = "Order details message template is a template with interactive components that extends the call-to-action button to support sending order details and provides a richer experience compared to templat..."
source = "https://developers.facebook.com/docs/whatsapp/orderdetailstemplate"
lang = "en"
tags = ["whatsapp-business-platform", "overview", "messaging", "templates"]
+++
