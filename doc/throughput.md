...
id = "throughput"
title = "Throughput"
summary = "For each registered business phone number, Cloud API supports up to 80 messages per second (mps) by default, and up to 1,000 mps by automatic upgrade."
source = "https://developers.facebook.com/docs/whatsapp/throughput"
lang = "en"
tags = ["whatsapp-business-platform", "webhooks", "messaging", "phone-numbers", "rate-limits"]
+++
# Throughput
