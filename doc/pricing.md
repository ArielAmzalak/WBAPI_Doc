...
summary = "Groups API uses Cloud API's per-message pricing model to determine if a given message is billable. However, you are charged each time a billable message is delivered to someone in the group."
source = "https://developers.facebook.com/docs/whatsapp/pricing"
lang = "en"
tags = ["whatsapp-business-platform", "webhooks", "messaging", "rate-limits", "pricing", "analytics"]
+++
# Groups API Pricing
