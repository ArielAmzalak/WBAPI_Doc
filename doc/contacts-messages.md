...
summary = "Contacts messages allow you to send rich contact information directly to WhatsApp users, such as names, phone numbers, physical addresses, and email addresses."
source = "https://developers.facebook.com/docs/whatsapp/contacts-messages"
lang = "en"
