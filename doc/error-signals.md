...
id = "error-signals"
title = "Error Signals"
summary = "The OTP Android SDK is in beta and features a simplified workflow for implementing one-tap and zero-tap authentication templates. You can learn how to use it below."
source = "https://developers.facebook.com/docs/whatsapp/error-signals"
lang = "en"
tags = ["whatsapp-business-platform", "tools"]
+++
# Error Signals
