+++
id = "autofill-button-authentication-templates"
title = "One-tap autofill authentication templates"
summary = "One-tap autofill authentication templates allow you to send a one-time password or code along with an one-tap autofill button to your users."
source = "https://developers.facebook.com/docs/whatsapp/autofill-button-authentication-templates"
lang = "en"
tags = ["whatsapp-business-platform", "webhooks", "templates", "authentication", "rate-limits", "tools"]
+++
...
* None of the other apps that you included in the templates list of `supported_apps` initiated a handshake in the last 10 minutes (or the number of minutes indicated by the template's `code_expiration_minutes` property, if present).
