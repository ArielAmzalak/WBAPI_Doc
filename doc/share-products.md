+++
id = "share-products"
title = "Share products with WhatsApp users"
summary = "You have multiple ways to share products with your customers."
source = "https://developers.facebook.com/docs/whatsapp/share-products"
lang = "en"
tags = ["whatsapp-business-platform", "overview", "messaging", "templates", "rate-limits"]
+++
...
Populated dynamically so can be personalized to the customer or situation. For example, you can show a Multi-Product Message of a customers most frequently ordered items.
...
* Responding to a customers specific request.
