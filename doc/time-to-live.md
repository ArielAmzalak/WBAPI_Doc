...
id = "time-to-live"
title = "Time-to-live"
summary = "If we are unable to deliver a message to a WhatsApp user, we will retry the delivery for a period of time known as a time-to-live (\"TTL\"), or the message validity period."
source = "https://developers.facebook.com/docs/whatsapp/time-to-live"
lang = "en"
