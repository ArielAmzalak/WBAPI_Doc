...
summary = "If your mobile app offers users the option to receive one-time passwords or verification codes via WhatsApp, you must use an authentication template."
source = "https://developers.facebook.com/docs/whatsapp/authentication-templates"
lang = "en"
tags = ["whatsapp-business-platform", "templates", "authentication", "security"]
+++
...
```
{
  "data": [
    ...
    {
      "body": "Tu codigo de verificacion es *{{1}}*. Por tu seguridad, no lo compartas.",
      "buttons": [
        {
      ...
      "footer": "Este codigo caduca en 10 minutos.",
      "language": "es_ES"
    }
  ]
}
