+++
id = "interactive-list-messages"
title = "Interactive list messages"
summary = "Interactive list messages allow you to present WhatsApp users with a list of options to choose from (options are defined as rows in the request payload):"
source = "https://developers.facebook.com/docs/whatsapp/interactive-list-messages"
lang = "en"
...
| `<MESSAGE_FOOTER_TEXT>`  *String* | **Optional.**  Message footer text.  Maximum 60 characters. | `Lucky Shrub: Your gateway to succulentsTM` |
...
-d '
{
  ...
  "interactive": {
    ...
    "footer": {
      "text": "Lucky Shrub: Your gateway to succulentsTM"
    },
    "action": {
